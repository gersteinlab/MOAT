...
MOAT-a and MOAT-v can retrieve precomputed whole genome signal scores for the input variants, which are combined into annotation scores based upon the sum of the scores of the intersecting variants. We provide precomputed Funseq scores on the MOAT website at: []. These scores were generated by running Funseq2 over the entire human genome, saving the highest possible Funseq score at each location.
