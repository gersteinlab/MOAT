...
int main (int argc, char* argv[]) {
	...
	if (mpi_rank == 0) { // Parent process
		...
		if (argc < 10) {
			fprintf(stderr, "Usage: moat_s_mpi [3mer preservation option (y/n)] [# permuted datasets] [permutation window width] [min width] [prohibited regions file] [FASTA dir] [variant file] [output folder] [covariate files ...]. Exiting.\n");
